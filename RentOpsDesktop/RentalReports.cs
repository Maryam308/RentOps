...
namespace RentOpsDesktop
{
    public partial class RentalReports : Form
    {
        ...
        private void RentalReports_Load(object sender, EventArgs e)
        {
            ...
            isLoaded = true; // Mark as loaded so that the documents load only after the page is fully loaded 
        ...
        private void btnGenerateRentalReport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int employeeID = Global.user.UserId;
                var employee = Global.user;
...
";
                ...
                int numberOfWebsiteRental = dbContext.RentalTransactions.Where(r => r.RentalRequestId != null).Count(); //this will fetch the number of website requests - transactions
                int numberOfFormApplicationRental = dbContext.RentalTransactions.Where(r => r.RentalRequestId == null).Count(); //when the request id is null then the transactions are from the form application

                //calculate total income 
                double rentalsIncome = dbContext.RentalTransactions.Any() ? dbContext.RentalTransactions.Sum(r => r.RentalFee) : 0;

                //calculate the average deposit amount in the rental transactions
                double averageDepositAmount = dbContext.RentalTransactions.Any() ? dbContext.RentalTransactions.Average(r => r.Deposit) : 0;

                //fetch th most rented equipment and select its id 
                ...
                //if there is an equipment found fetch its name and add it in the variable
                ...
                //fetch the least rented equipment id
                ...
                //get the name of th least equipment rented if fetched
                ...
                //get the equipment with the high ratings
                ...
                //get the highly rated equipment name
                ...
                //get the most common condition of the equipment
                ...
                //get the most common condition title 
...
*************************";
                ...
                //set the styling and font for the page
